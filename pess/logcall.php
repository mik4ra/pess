...
<link href="jiawei.css" rel="stylesheet" type="text/css">	
</head>
<body>
<script>
function jiawei()
{
	...
	//may add code for validation other inputs
}
</script>
...
<form name="frmLogCall" method="post" action="dispatch.php" onSubmit="return jiawei();">
